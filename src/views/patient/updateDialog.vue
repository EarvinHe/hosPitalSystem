      ...
      >
        ...
        >
          ...
          <el-form-item label="患者电话">
            <el-input
              v-model="PatientUpdateForm.patientTelphone"
            ></el-input>
          </el-form-item>
          ...
          <el-button class="finishUpdate" type="primary" size="small" @click="updatePatient">完成</el-button>
        </el-form>
      </el-dialog>
    </div>
  </template>
    ...
    //   修改患者数据
      async updatePatient(){
        try {
            ...
            await this.$store.dispatch('updatePatient',data)
            this.$message({
              message: "修改成功",
              type: "success",
              showClose: true,
